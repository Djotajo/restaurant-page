export default function loadHotdog() {
  const hotdogs = document.querySelector(".currentTab");
  hotdogs.setAttribute("id", "foods");
  hotdogs.innerHTML = "";
