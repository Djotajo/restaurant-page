export default function loadChicken() {
  ...
  chickenArr.forEach((element) => {
    ...
    chicks.appendChild(foodImg);
    chicks.appendChild(foodDescription);
  });
}
